      ...
      <Container>
        <ContactSectionContent ref={ref}>
          <motion.div style={{ scale }}>
            <ContactSectionText>
              <Text type="heading2" color="grey2">
                Desenvolvemos soluções inovadoras e personalizadas! {" "}
                Entre em contato para colaborarmos juntos!
              </Text>
            </ContactSectionText>
          </motion.div>
          <ContactsCards>
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Podemos criar interações mais constantes assim
                </Text>
                <Text
                  as="a"
                  color="grey2"
